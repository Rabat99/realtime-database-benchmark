...
def concurrency_profile(intervals):
    ...
    einem Zeitpunkt alle N gemessenen Hydrationen gleichzeitig
    aktiv waren.
    """
    ...
    return {
        "peak_concurrent_hydrations": peak,
...
class InitPool(ZeroSubscriberPool):
...
async def run(args):
    ...
    try:
        ...
        # --------------------------------------------------------------
        # Alle Clients muessen vor dem gemessenen Query-Start bereits
        # mit Zero verbunden und an der Barriere angekommen sein.
        # --------------------------------------------------------------
        ...
        # --------------------------------------------------------------
        # Auf alle initialen Query-Ergebnisse warten.
        # --------------------------------------------------------------
        ...
        # --------------------------------------------------------------
        # Nur Querys mit Start- UND Ready-Event auswerten.
        # --------------------------------------------------------------
        ...
        # Startstreuung:
        #
        # Nur Client-Zeitstempel werden miteinander verglichen.
        # Die Kennzahl wird berichtet, ist aber KEINE harte
        # Validitaetsgrenze.
        # --------------------------------------------------------------
        ...
        # Die 20-Prozent-Grenze wird ausschliesslich als Diagnosewert ausgegeben.
        ...
        # Direkter Nachweis der gewuenschten Parallelitaet:
        # Zu mindestens einem Zeitpunkt muessen alle N Hydrationen
        # gleichzeitig aktiv gewesen sein.
...
def main():
    parser = argparse.ArgumentParser(
        description=(
            "Zero subscription-init benchmark "
            "with synchronized query-start barrier."
        )
    )
    ...
    # Diagnosewert ohne Einfluss auf valid_run.
    parser.add_argument(
